...
"></path></svg></span>
                    ...
                    <div class="test">
                        ...
                        <div class="modalBlock"><!--Блок модального окна-->
                            ...
                            <div class="blockCont" id="blockCont">
        ...
        <div class="price">
            ...
            <div class="content__price">
                ...
                <div class="slider">
                    ...
                    <div class="start">
                        <span>Старт</span>
                        <ul style="color: #fefefe; line-height: 1.5;">
                            <li class="li2"><b>500 заказов</b></li>
                            <li class="li2"><b>2 сотрудника</b></li><br>
                            <li>статистика продаж</li>
                            <li>учет склада и остатков</li>
                            <li>интеграция с лендингами<br>и интернет-магазинами</li>
                            <li>новая модульная система<br>(Нова Пошта, Instagram)</li>
                            <li>массовая SMS рассылка</li>
                            <li>интеграция IP-телефонии</li>
                    ...
                    <div class="business">
                        <span>Бизнесс</span>
                        <ul style="color: #fefefe; line-height: 1.5;">
                            <li class="li2"><b>1000 заказов</b></li>
                            <li class="li2"><b>5 сотрудника</b></li><br>
                            <li>статистика продаж</li>
                            <li>учет склада и остатков</li>
                            <li>интеграция с лендингами<br>и интернет-магазинами</li>
                            <li>новая модульная система<br>(Нова Пошта, Instagram)</li>
                    ...
                    <div class="vip">
                        <span>VIP</span>
                        <ul style="color: #fefefe; line-height: 1.5;">
                            <li class="li2"><b>∞ заказов</b></li>
                            <li class="li2"><b>∞ сотрудника</b></li><br>
                            <li>статистика продаж</li>
                            <li>учет склада и остатков</li>
                            <li>интеграция с лендингами<br>и интернет-магазинами</li>
                            <li>новая модульная система<br>(Нова Пошта, Instagram)</li>
